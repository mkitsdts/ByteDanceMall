...
const (
	...
	AuthService_KickoffUser_FullMethodName         = "/auth.AuthService/KickoffUser"
...
type AuthServiceClient interface {
	...
	KickoffUser(ctx context.Context, in *KickoffUserReq, opts ...grpc.CallOption) (*KickoffUserResp, error)
...
func (c *authServiceClient) KickoffUser(ctx context.Context, in *KickoffUserReq, opts ...grpc.CallOption) (*KickoffUserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(KickoffUserResp)
	err := c.cc.Invoke(ctx, AuthService_KickoffUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	KickoffUser(context.Context, *KickoffUserReq) (*KickoffUserResp, error)
...
func (UnimplementedAuthServiceServer) KickoffUser(context.Context, *KickoffUserReq) (*KickoffUserResp, error) {
...
func _AuthService_KickoffUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KickoffUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).KickoffUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_KickoffUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).KickoffUser(ctx, req.(*KickoffUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_KickoffUser_Handler,
		},
		{
